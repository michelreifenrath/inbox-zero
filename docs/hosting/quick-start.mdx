...
The CLI will walk you through configuring [Google OAuth](/hosting/google-oauth) or [Microsoft OAuth](/hosting/microsoft-oauth) and your AI provider. STRATO and custom IMAP/SMTP mailboxes can also be added from the app; see [IMAP and STRATO](/hosting/imap-strato) for settings, polling behavior, and limitations. For manual configuration, see the [Setup Guides](/hosting/setup-guides).
...
<CardGroup cols={2}>
  ...
  <Card title="IMAP and STRATO" icon="mail" href="/hosting/imap-strato">
    Connect STRATO or custom IMAP/SMTP mailboxes.
  </Card>
